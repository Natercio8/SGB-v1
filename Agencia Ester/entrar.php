...
<?php
    if (isset($_POST['email'])) {
        ...
        $conectar = $conn->prepare("SELECT * FROM cliente where email_cliente=:email AND senha=:senha");
        ...
        if (empty($buscarDados)) {
            ...
            $_SESSION['id_cliente'] = $buscarDados['id_cliente'];
            $_SESSION['nome_cliente'] = $buscarDados['nome_cliente'];

            $_SESSION['endereco'] = $buscarDados['endereco'];
